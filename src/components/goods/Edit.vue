			...
			<el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px" label-position="top">
				<el-tabs v-model="activeIndex" tab-position="left">
					...
					<el-tab-pane label="商品图片" name="3">
						<el-upload action="http://212.64.72.253:3000/api/private/v1/upload" :on-preview="handlePreview" :file-list="imgList"
					...
					<el-tab-pane label="商品内容" name="4">
						...
						<el-button type="primary" class="btnEdit" @click="postEdit">确认修改商品信息</el-button>
					</el-tab-pane>
				</el-tabs>
			</el-form>
		</el-card>
...
<script>
	export default {
		...
		methods: {
			//获取商品信息
			getGoodsInfo() {
				this.$http.get(`goods/${this.$route.params.id}`).then(response => {
